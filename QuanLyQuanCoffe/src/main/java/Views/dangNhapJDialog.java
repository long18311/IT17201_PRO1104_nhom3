...
public class dangNhapJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
     ...
     void exit(){
        if(JOptionPane.showConfirmDialog(this, "Bạn có chắc chắn muốn thoát không?", "Thông báo", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
            System.exit(0);
        }
    }
    ...
    void login() {
        ...
        try {
            QLNhanVien nhanVien = nhanVienService.getNhanVienById(manv);
            /*
