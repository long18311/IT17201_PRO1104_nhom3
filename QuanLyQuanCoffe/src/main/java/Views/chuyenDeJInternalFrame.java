...
public class chuyenDeJInternalFrame extends javax.swing.JInternalFrame {
    ...
    */
    void insert() {
        QLChuyenDe model = getModel();
        try {
            chuyenDeService.createNewQLChuyenDe(model);
            this.load();
            this.clear();
    ...
    void update() {
        QLChuyenDe model = getModel();
        try {
            chuyenDeService.updateQLChuyenDeById(model);
            this.load();
    ...
    void delete() {
        if (dialogHelper.confirm(this, "Bạn có muốn xóa hay không?")) {
            ...
            try {
                chuyenDeService.deleteQLChuyenDeById(macd);
                this.load();
                this.clear();
    ...
    void edit() {
        try {
            ...
            QLChuyenDe model = chuyenDeService.getQLChuyenDeById(macd);
            if (model != null) {
                this.setModel(model);
    ...
    void setModel(QLChuyenDe model) {
    ...
    //return chuyenDe
    QLChuyenDe getModel() {
        QLChuyenDe model = new QLChuyenDe();
    ...
    */
    ...
    public boolean checkTrungMa(JTextField txt) {
        ...
        if (chuyenDeService.getQLChuyenDeById(txt.getText()) == null) {
            return true;
        } else {
