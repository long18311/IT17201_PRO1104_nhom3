...
import static Utilities.shareHelper.USER;
...
public class nhanVienJInternalFrame extends javax.swing.JInternalFrame {
    ...
    void load() {
        ...
        try {
            List<QLNhanVien> list = nhanVienService.getNhanViens();   //lấy tất cả nhân viên trong CSDL đưa vào list
            /*
    ...
    void insert() {
        ...
        if (confirm.equals(model.getMatKhau())) {
            try {
                nhanVienService.createNewNhanVien(model);
    ...
    void update() {
        ...
        if (!confirm.equals(model.getMatKhau())) {
            ...
            try {
                nhanVienService.updateNhanVienById(model);     //cập nhật nhân viên theo maNV
    ...
    void delete() {
        if (dialogHelper.confirm(this, "Bạn thực sự muốn xóa nhân viên này?")) {
            ...
            try {
                nhanVienService.deleteNhanVienById(manv);   //xóa nhân viên theo maNV
                this.load();        //điền tt mới vào bảng
    ...
    void edit() {
        ...
        try {
            ...
            QLNhanVien model = nhanVienService.getNhanVienById(manv); //dùng maNV tìm ra đối tượng nhanVien
            if (model != null) {
    ...
    void clear() {
        setTrang();
        this.setModel(new QLNhanVien());  //xóa trắng form
        this.setStatus(true);
    }
    ...
    public boolean checkTrungMa(JTextField txt) {
        ...
        if (nhanVienService.getNhanVienById(txt.getText()) == null) {
            return true;
        } else {
    ...
    public boolean checkChinhMinh(JTextField txt){
        QLNhanVien nv= nhanVienService.getNhanVienById(txt.getText());
